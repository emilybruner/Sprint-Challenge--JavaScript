...
lowCaseAnimalNames = zooAnimals.map(el => el.animal_name.toLowerCase())
...
lowPopulationAnimals = zooAnimals.filter(el => el.population < 5)
...
populationTotal = zooAnimals.reduce(function (populationTotal, currentValue) {
